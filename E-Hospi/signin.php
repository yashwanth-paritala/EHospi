...
<html lang="en">
                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                                ...
                                <a href="index.html" class="navbar-brand"><img src="images/24652templatemo_logo.png"" alt="E&#8209;Hospi Logo" title="E&#8209;Hospi Logo" /></a>
                        </div>
 ...
 <center>       
        <div class="form">
	<h4>Patient's log in</h4>
			<form method="post" action=" " onSubmit="return validate(this);" name="form">
				<input type="text" name="username" class="password" placeholder="aadharnumber" required><br><br>
			...
			<br>
		<p><a href="error404.html">forgot password?</a></p>
</div>
</center>
